...
void parseSerialLine(String line) {
    ...
    systolic  = line.substring(0, firstComma).toInt();
    diastolic = line.substring(firstComma + 1, secondComma).toInt();
    heartRate = line.substring(secondComma + 1).toInt();

    Serial.print("Updated sliders: ");
    Serial.print(systolic); Serial.print(",");
    Serial.print(diastolic); Serial.print(",");
